      ...
      <div className="banner-content">
        ...
        <div className='banner-intro-text'>
            ...
            <div className="social-icons">
                <a href="https://github.com/Sobia-s" target="_blank" rel="noopener noreferrer">
                    <FaGithub className="icon" />
                    <span className="icon-label">GitHub</span>
                </a>
                <a href="https://www.linkedin.com/in/sobiasoomro/" target="_blank" rel="noopener noreferrer">
                    <FaLinkedin className="icon" />
                    <span className="icon-label">LinkedIn</span>
                </a>
                <a href="https://g.dev/sobiasoomro" target="_blank" rel="noopener noreferrer">
                    <FaGlobe className="icon" />
                    <span className="icon-label">Google Developer Profile</span>
                </a>
                <a href="mailto:sobiasoomro97@gmail.com" target="_blank" rel="noopener noreferrer">
...
<section class="featured-projects-section">
    <div class="projects-intro-section">
        <div class="line-container">
            <div class="line"></div>
            <span class="projects-intro-text">SOME OF MY LATEST WORK</span>
            <div class="line"></div>
        </div>
    </div>
    <div class="projects-container">
    <a href="https://lucky-shrub-garden-firm.netlify.app/" target="_blank" className='project-link'>
            <div class="cards">
        ...
        <a href="https://my-capstone.netlify.app/" target="_blank"className='project-link'>
            <div class="cards">
        ...
        <a href="https://myreact-projects.netlify.app/" target="_blank" className='project-link'>
            <div class="cards">
                <img src={img3} alt="Portfolio website project" className='card-img'/>
               <div className='card-content'>
                <h3 className='project-title'>Portfolio Website</h3>
                <p className='project-description'>A modern React-based portfolio featuring functional form submission, a stunning responsive design, and intuitive navigation</p>
              </div>
            </div>
        </a>
    </div>
