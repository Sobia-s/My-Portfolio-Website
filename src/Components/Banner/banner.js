    ...
    <>
      ...
      <section className="featured-projects-section">
        ...
        <div className="projects-container">
          <a
            href="https://lucky-shrub-garden-firm.netlify.app/"
            target="_blank"
            ...
            <div className="cards">
              ...
              <div className="card-content">
                ...
                <p className="project-description">
                  ...
                  showcasing a stunning design and an integrated checkout
                  process
                </p>
              </div>
            </div>
          ...
          <a
            href="https://my-capstone.netlify.app/"
            target="_blank"
            rel="noopener noreferrer"
            className="project-link"
          >
            <div className="cards">
              ...
              <div className="card-content">
                ...
                <p className="project-description">
                  A responsive React-based platform for table reservations,
                  featuring dynamic booking and an appealing, user-friendly
                  layout
                </p>
              </div>
            </div>
          ...
          <a
            href="https://myreact-projects.netlify.app/"
            target="_blank"
            rel="noopener noreferrer"
            className="project-link"
          >
            <div className="cards">
              ...
              <div className="card-content">
                ...
                <p className="project-description">
                  A modern React-based portfolio featuring functional form
                  submission, a stunning responsive design, and intuitive
                  navigation
                </p>
              </div>
            </div>
